Contributing to docker-cikl-redis
============================

You're encouraged to submit [pull requests](https://github.com/cikl/docker-cikl-redis/pulls), [propose features and discuss issues](https://github.com/cikl/docker-cikl-redis/issues).

#### Fork the Project

Fork the [project on Github](https://github.com/cikl/docker-cikl-redis) and check out your copy.

```
git clone https://github.com/contributor/docker-cikl-redis.git
cd cikl
git remote add upstream https://github.com/cikl/docker-cikl-redis.git
```
...
Go to https://github.com/contributor/docker-cikl-redis and select your feature branch. Click the 'Pull Request' button and fill out the form. Pull requests are usually reviewed within a few days.
...
```
* [#123](https://github.com/cikl/docker-cikl-redis/pull/123): Reticulated splines - [@contributor](https://github.com/contributor).
```
